...
const utils = require('./util/utils'),
        schedule = require('pomelo-scheduler-upgrade'),
        protocol = require('./util/protocol'),
        MasterAgent = require('./master/masterAgent'),
        MonitorAgent = require('./monitor/monitorAgent'),
        EventEmitter = require('events').EventEmitter,
        logger = require('pomelo-logger-upgrade').getLogger('pomelo_admin', 'ConsoleService');
